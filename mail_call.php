...
$subject= 'Замовлення дзінка з сайту ЗПК';
$from = 'ЗПК-ЗемПроКонсалтинг';
...
<a href="https://zemprogeo.com.ua" class="email-logo" style="float: left;"><img src="https://zemprogeo.com.ua/wp-content/uploads/2017/12/logo.png" alt="ЗПК-ЗемПроКонсалтинг"></a>
<div class="email-cocial-wrap" style="float: right; text-align:left;">
</div>
</div>
<div class="email-header-top" style="padding-top: 80px; text-align: center; font-size: 24px; text-transform: uppercase; font-weight: bold; line-height: 34px; clear: both;" align="center">Вам прийшов лист з сайту<br><a style="color:#dfdfdf;text-decoration: none;" href="https://zemprogeo.com.ua/">ЗПК-ЗемПроКонсалтинг</a></div>
</div>
</div>
